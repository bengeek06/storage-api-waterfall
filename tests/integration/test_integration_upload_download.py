...
class TestUploadProxy:
    ...
    def test_upload_proxy_missing_fields(
    ...
    def test_upload_proxy_wrong_bucket(
        self, client, test_user_id, test_company_id
    ):
    ...
    def test_upload_proxy_companies_bucket(
        self, client, test_user_id, test_company_id
    ):
...
class TestDownloadPresign:
    ...
    def test_download_presign_success(
        ...
        assert (
            "localhost:9000" in json_data["url"] or "minio" in json_data["url"]
        )

    def test_download_presign_file_not_found(
        self, client, test_user_id, test_company_id
    ):
    ...
    def test_download_presign_no_permission(
        self, client, db, test_user_id, test_company_id, sample_file
    ):
    ...
    def test_download_presign_custom_expiry(
        self, client, db, test_user_id, test_company_id, sample_file
    ):
...
class TestDownloadProxy:
    ...
    def test_download_proxy_success(
        self,
        client,
        db,
        test_user_id,
    ...
    def test_download_proxy_file_not_found(
        self, client, test_user_id, test_company_id
    ):
    ...
    def test_download_proxy_no_permission(
        self, client, db, test_user_id, test_company_id, sample_file
    ):
...
class TestUploadDownloadFlow:
    ...
    def test_full_upload_download_flow(
        ...
        upload_data = {
            ...
            "file": FileStorage(
                stream=io.BytesIO(original_content),
                filename=filename,
                content_type="text/plain",
            ),
        }

...
class TestFileDelete:
    ...
    def test_delete_logical_only(self, client, db, test_user_id, test_company_id, sample_file):
    ...
    def test_delete_no_permission(self, client, db, test_user_id, test_company_id, sample_file):
    ...
    def test_delete_missing_file_id(self, client, test_user_id, test_company_id):
...
class TestLocksList:
    ...
    def test_locks_list_with_locks(self, client, db, test_user_id, test_company_id, locked_file):
    ...
    def test_locks_list_filter_by_file_id(self, client, db, test_user_id, test_company_id, locked_file):
    ...
    def test_locks_list_filter_by_bucket(self, client, db, test_user_id, test_company_id, locked_file):
    ...
    def test_locks_list_no_access_to_other_buckets(self, client, db, test_user_id, test_company_id):
...
class TestDeleteAndLocksIntegration:
    ...
    def test_delete_locked_file(self, client, db, test_user_id, test_company_id, locked_file):

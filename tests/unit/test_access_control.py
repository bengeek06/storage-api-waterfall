...
from flask import g
from app.utils import check_bucket_access, check_project_access, check_project_access_batch
...
class TestBucketAccess:
    ...
    def test_users_bucket_own_access(self, app):
        ...
        with app.test_request_context():
            ...
            allowed, error, status = check_bucket_access("users", "user-123", "read")
    ...
    def test_users_bucket_other_access_denied(self, app):
        ...
        with app.test_request_context():
            ...
            allowed, error, status = check_bucket_access("users", "user-999", "read")
    ...
    def test_companies_bucket_own_access(self, app):
        ...
        with app.test_request_context():
            ...
            allowed, error, status = check_bucket_access("companies", "company-456", "write")
    ...
    def test_companies_bucket_other_access_denied(self, app):
        ...
        with app.test_request_context():
            ...
            allowed, error, status = check_bucket_access("companies", "company-999", "write")
    ...
    def test_invalid_bucket_type(self, app):
        ...
        with app.test_request_context():
            ...
            allowed, error, status = check_bucket_access("invalid", "bucket-id", "read")
    ...
    def test_projects_bucket_delegates_to_service(self, mock_check_project, app):
        ...
        with app.test_request_context():
            ...
            mock_check_project.assert_called_once_with("project-789", "read", "file-abc")
            assert allowed is True
...
class TestProjectAccess:
    ...
    def test_project_access_allowed(self, mock_post, app):
        ...
        with app.test_request_context():
            ...
            mock_response.json.return_value = {"allowed": True, "role": "admin"}
            mock_post.return_value = mock_response

            allowed, error, status = check_project_access("project-123", "write")
    ...
    def test_project_access_denied(self, mock_post, app):
        ...
        with app.test_request_context():
            ...
            allowed, error, status = check_project_access("project-123", "delete")
    ...
    def test_project_service_timeout(self, mock_post, app):
        ...
        with app.test_request_context():
            ...
            allowed, error, status = check_project_access("project-123", "read")
